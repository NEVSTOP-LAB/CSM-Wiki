...
CSM 框架在多个技术研讨会和线上活动中进行了分享，相关演讲材料已在 [csm-keynotes-collection](https://github.com/NEVSTOP-LAB/csm-keynotes-collection) 仓库中公开。这些材料涵盖了 CSM 的架构设计、应用场景和实例分析，适合想要深入了解 CSM 框架的开发者参考。

主要演讲包括：

- **NI全联结峰会2024** (2024.11) - CSM架构全面介绍
- **NI测试测量技术研讨会深圳站** (2024.12) - CSM简要演示
- **NI Webinar** (2025.07) - CSM框架优势实例分析

> 📓
> 访问 [csm-keynotes-collection](https://github.com/NEVSTOP-LAB/csm-keynotes-collection) 获取完整的演讲资料和PDF文档。
>
