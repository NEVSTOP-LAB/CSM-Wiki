...
<b>参考范例</b>：[参数安全转义示例]({% link docs/examples/example-csm-basic-example.md %}#43-arguments---safe-arguments-if-it-contains-key-words-of-csmvi) - `[CSM-Example]\0. Base Concepts\4.3 Arguments - Safe Arguments if it contains key words of CSM.vi`。
...
<b>参考范例</b>：[复杂数据作为参数示例]({% link docs/examples/example-csm-basic-example.md %}#41-arguments---complex-data-as-argumentsvi) - `[CSM-Example]\0. Base Concepts\4.1 Arguments - Complex Data As Arguments.vi`。
...
<b>参考范例</b>：[错误作为参数示例]({% link docs/examples/example-csm-basic-example.md %}#42-arguments---error-as-argumentsvi) - `[CSM-Example]\0. Base Concepts\4.2 Arguments - Error As Arguments.vi`。
