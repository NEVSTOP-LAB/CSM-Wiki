...
模板面板提供创建CSM模块所需的各种模板，详见[CSM开发模板](./templates)。
...
- [CSM开发模板](./templates) - 详细的模板使用指南
- [CSM基本概念](../basic/concepts) - 理解CSM的核心概念
- [CSM模块间通讯](../basic/communication) - 通讯机制详解
- [创建CSM复用模块](../basic/usage) - 模块开发指南
- [CSM高级模式](../basic/advance) - 协作者、责任链等高级特性
- [CSM插件机制](../plugins/plugin-system) - Addon和Template开发
- [CSM调试工具](../plugins/tools) - 调试和开发工具
- [CSM全局日志](../basic/global-log) - 日志系统详解
...
- 深入学习[CSM高级模式](../basic/advance)
- 探索[CSM插件机制](../plugins/plugin-system)
- 实践[创建CSM复用模块](../basic/usage)
- 使用[CSM调试工具](../plugins/tools)优化开发流程
