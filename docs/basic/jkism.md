...
![JKISM 简介]({{ site.img_base | append: "/jkism/slide-10.png" | relative_url }})
...
![JKISM 核心结构]({{ site.img_base | append: "/jkism/slide-11.png" | relative_url }})
...
![JKISM 探针]({{ site.img_base | append: "/jkism/slide-12.png" | relative_url }})
...
![JKISM 编辑器]({{ site.img_base | append: "/jkism/slide-13.png" | relative_url }})
...
![技巧1：不要在子VI中隐藏状态字符串]({{ site.img_base | append: "/jkism/slide-14.png" | relative_url }})
...
![技巧2：不要在事件结构中添加代码和逻辑判断]({{ site.img_base | append: "/jkism/slide-15.png" | relative_url }})
...
![技巧3：保留原生架构尺度]({{ site.img_base | append: "/jkism/slide-16.png" | relative_url }})
...
![技巧4：使用宏替代链式序列状态]({{ site.img_base | append: "/jkism/slide-17.png" | relative_url }})
...
![技巧5：左对齐替代右对齐状态字符串]({{ site.img_base | append: "/jkism/slide-18.png" | relative_url }})
...
![JKISM Demo 步骤]({{ site.img_base | append: "/jkism/slide-19.png" | relative_url }})
