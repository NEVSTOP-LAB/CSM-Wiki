...
```labview
[`CSM - Argument Type.vi`]({% link docs/reference/api-03-arguments.md %}#csm---argument-typevi)
...
**[`API String - Set Float Precision.vi`]({% link docs/reference/api-addon-api-string.md %}#api-string---set-float-precisionvi)**
- 设置浮点数的精度
- 默认6位有效数字
- 影响Float到String的转换
