...
CSM提供了一整套开发和调试工具，帮你更快地开发、调试和维护应用。工具分为四大类：运行时调试、开发辅助、接口管理和示例浏览。所有调试工具都基于[全局日志系统](../basic/global-log)实现。
...
![CSM Tool Entry in Menu]({{ site.img_base | append: "/Tools/Debug%20Tool%20Entry%20in%20Tool%20Menu.png" | relative_url }})

打开后会弹出工具选择器，选你需要的工具就行：

![CSM Tool Selector]({{ site.img_base | append: "/Tools/Tool%20Selector.png" | relative_url }})
...
![CSM Running Log Window]({{ site.img_base | append: "/Tools/tool-RunningLogWindow.png" | relative_url }})
...
![CSM State Dashboard Window]({{ site.img_base | append: "/Tools/tool-DashboardWindow.png" | relative_url }})
...
![CSM Table Log Window]({{ site.img_base | append: "/Tools/tool-TableLogWindow.png" | relative_url }})
...
**开发流程**：
1. 获取全局日志（使用[`CSM - Global Log Queue.vi`]({% link docs/reference/api-07-global-log.md %}#csm-global-log-queuevi)或[`CSM - Global Log Event.vi`]({% link docs/reference/api-07-global-log.md %}#csm-global-log-eventvi)）
2. 处理日志数据，提取需要的信息
3. 实现业务逻辑
4. 显示或保存结果
